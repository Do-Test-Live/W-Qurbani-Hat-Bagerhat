...
if(isset($_GET['area']))
{
$sql = "SELECT * FROM subcategory,product WHERE subcategory.id= product.sid AND product.area = '$area'";
$result =  mysqli_query($con, $sql);
$row = mysqli_fetch_array($result);
}
else{
    header('Location: http://qurbanihatkhulna.com/');
}
?>
<!DOCTYPE html>
...
<head>
   ...
   <!-- Stylesheets
	============================================= -->
   <link rel="icon" href="https://admin.qurbanihatkhulna.com/<?php echo $favicon; ?>" type="image/gif" sizes="16x16">
         ...
         <div id="header-wrap">
            ...
            <div class="container clearfix">
               ...
               <!-- Logo
					============================================= -->
               <div id="logo">
                  <a href="index.php" class="standard-logo"><img src="https://admin.qurbanihatkhulna.com/<?php echo $logo; ?>" alt="Canvas Logo"></a>
                  <a href="index.php" class="retina-logo"><img src="https://admin.qurbanihatkhulna.com/<?php echo $logo; ?>" alt="Canvas Logo"></a>
               </div><!-- #logo end -->
				...
				<div class="container clearfix">
					...
					<div class="row grid-6" id="pagination_data">
					    <?php
                              ...
                              $query = "SELECT * FROM subcategory,product WHERE subcategory.id= product.sid AND product.area = '$area' LIMIT $page1,24";
                                    ...
                                    <div class="product iproduct clearfix">
                                        ...
                                        <div class="product-desc">
                                            <div class="product-title mb-1">
                                                <h3><a href="#"><?php echo 'QHK-' . $row['id'] ?> | <?php echo $row['pname']; ?></a></h3>
                                            </div>
            		...
            		<center>
            		    <?php
                              ...
                              $area = $_GET['area'];
                              $query1 = "SELECT * FROM subcategory,product WHERE subcategory.id= product.sid AND product.area = '$area'";
                              ...
                              for ($b = 1; $b <= $a; $b++) {
                              ?>
                                 <a href="km.php?page=<?php echo $b; ?>&area=<?php echo $area; ?>" class="btn btn-success"><?php echo $b?></a>
                              <?php
                              }
                        ?>      
            		</center>
