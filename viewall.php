			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="fancy-title title-dotted-border topmargin-sm mb-4 title-center">
                        <h2><u style="color: #5CD6C0">সকল পশু</u></h2>
					</div>
					...
					<div class="row grid-6" id="pagination_data">
					    <?php
                              ...
                              $query = "SELECT * FROM product where status='1' LIMIT $page1,24";
                            ...
                            <div class="col-12">
                                ...
                                <nav aria-label="Page navigation example" class="text-center">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        $query1 = "SELECT * FROM product where status='1'";
                                        ...
                                        ?>
                                        <li class="page-item">
                                            <a class="page-link" href="viewall.php?page=<?php echo $currentPage-1; ?>" aria-label="Previous">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="viewall.php?page=<?php echo $currentPage+1; ?>" aria-label="Next">
